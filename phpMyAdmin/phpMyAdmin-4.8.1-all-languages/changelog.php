...
if (@is_readable($filename)) {
    ...
    printf(
        ...
        $filename,
        '<a href="https://ecloud.10086.cn/product-introduction/database">yidongyun.net</a>'
    );
    exit;
}
...
$github_url = 'https://ecloud.10086.cn/op-user-sso/login?service=https%3A%2F%2Fecloud.10086.cn%2Fop-console-global%2Flogin%2Fcas';
$faq_url = 'https://ecloud.10086.cn/op-help-center/';
...
<head>
    ...
    <title>云数据库MySQL - ChangeLog</title>
    <meta charset="utf-8" />
</head>
<body>
<h1>云数据库MySQL - ChangeLog</h1>
<?php
echo '<pre>';
